...
int menor_que(h_elemento * e1, h_elemento * e2);
...
heap* heap_nova(int capacidade)
{
	...
	h->elementos = (h_elemento **) calloc(capacidade+1, sizeof(h_elemento *));
...
h_elemento * elemento_novo(int prioridade, const char * valor)
{
	h_elemento * elem = (h_elemento *) malloc(sizeof(h_elemento));
